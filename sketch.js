...
function preload() {
  backgroundImg = loadImage("./assets/apocalypse.png");
  backgroundMusic = loadSound("./assets/background_music.mp3");
  
  pirateLaughSound = loadSound("./assets/pirate_laugh.mp3");
  cannonExplosion = loadSound("./assets/cannon_explosion.mp3");
  towerImage = loadImage("./assets/tower.png");
  boatSpritedata = loadJSON("assets/zombie/Zombiefly.json");
  boatSpritesheet = loadImage("assets/zombie/Zombiefly.png");
...
function setup() {
  ...
  tower = new Tower(150, 350, 300, 400);
